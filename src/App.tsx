...
const App = () => {
    return (
        <div id="__next">
            <div className="absolute w-full min-h-screen bg-white shadow-none flex flex-col overflow-hidden transition-colors" style={{ zIndex: 999 }}>
                {/*<div className="hidden">{"darkMode ": false}</div>*/}
                <div className="w-full h-auto min-h-screen text-white">
                    <div className="w-full h-screen relative flex flex-row gap-24 justify-center px-8">
                        <div className="max-w-6xl bg-gray w-full flex flex-row">
                            <div className="w-full md:w-1/2 h-full flex flex-col justify-center z-20 gap-4 ">
                                ...
                                <h1 className="text-4xl md:text-8xl lg:text-6xl font-montserrat font-extrabold text-gray-900 dark:text-gray-50">Toan
                                    Pham</h1>
                                ...
                                <div className="flex flex-row gap-4 mt-8">
                                    <a className="text-lg font-montserrat text-gray-400 dark:text-gray-500 dark:hover:text-purple-400 hover:text-purple-800 hover:underline"
                                       href="/resume">Resume</a>
                                    <a className="text-lg font-montserrat text-gray-400 dark:text-gray-500 dark:hover:text-purple-400 hover:text-purple-800 hover:underline"
                                       href="/projects">Projects</a>
                                    <a className="text-lg font-montserrat text-gray-400 dark:text-gray-500 dark:hover:text-purple-400 hover:text-purple-800 hover:underline"
                                       href="/card">Contact Card</a>
                                </div>
                            </div>
                ...
                <footer
                    ...
                    <div
                        className="flex flex-row gap-0 items-center justify-center text-gray-900/40 dark:text-gray-100/50 group-hover:max-w-2xl max-w-0 overflow-hidden transition-all duration-150 whitespace-nowrap group-hover:pl-2">Toggle
                        Light Mode
                    </div>
                    <button
